            ...
            try {
                for (var _iterator = players.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    if (player.nickname !== this.props.nickname) {
                        var left = player.cursor.x + 'px';
                        var top = player.cursor.y + 'px';

                        items.push(React.createElement(
                            'span',
                            { key: index, className: 'player-cursor', style: { left: left, top: top }, __source: {
                                    fileName: _jsxFileName,
                                    lineNumber: 11
                                },
                                __self: this
                            },
                            React.createElement('i', { className: 'fas fa-hand-point-up fa-2x', __source: {
                                    fileName: _jsxFileName,
                                    lineNumber: 12
                                },
                                __self: this
